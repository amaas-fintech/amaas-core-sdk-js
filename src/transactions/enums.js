export const TRANSACTION_TYPES = [ 'Allocation', 'Block', 'Exercise', 'Expiry', 'Journal', 'Maturity', 'Net', 'Novation', 'Split', 'Trade', 'Transfer', 'Cashflow', 'Coupon', 'Dividend', 'Payment', ...CASH_TRANSACTION_TYPES ]
