export const TRANSACTION_TYPES = [ 'Allocation', 'Block', 'Cashflow', 'Coupon', 'Dividend', 'Exercise', 'Expiry', 'Payment', 'Journal', 'Maturity', 'Net', 'Novation', 'Split', 'Trade', 'Transfer', ...CASH_TRANSACTION_TYPES ]
